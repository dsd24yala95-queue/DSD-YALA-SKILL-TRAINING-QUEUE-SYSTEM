                ...
                <div className="max-w-7xl mx-auto w-full relative z-20 flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 lg:px-8 pb-32">
                    ...
                    <div className="w-full md:w-[55%] pt-10 md:pt-0 flex flex-col justify-center text-left">
                        ...
                        <div className="flex flex-col gap-4 w-full max-w-md">
                            <Link href="/booking?type=test" className="group relative flex items-center bg-slate-900/70 backdrop-blur-2xl border border-slate-700/60 hover:border-blue-500/60 text-white rounded-2xl overflow-hidden transition-all duration-300 shadow-xl hover:shadow-[0_0_30px_rgba(59,130,246,0.35)] hover:-translate-y-0.5">
                                ...
                                <div className="px-6 py-4 flex-1 flex items-center justify-between">
                                    <div className="text-left">
                                        <div className="font-bold text-sm md:text-base flex items-center gap-2 text-white group-hover:text-blue-200 transition-colors">
                                            ดูสาขาทดสอบมาตรฐาน <span className="bg-red-500/90 text-white text-[10px] font-extrabold px-2 py-0.5 rounded-full leading-none uppercase shadow-sm shadow-red-500/50 animate-pulse">HOT</span>
                                        </div>
                            ...
                            <Link href="/booking?type=training" className="group relative flex items-center bg-slate-900/70 backdrop-blur-2xl border border-slate-700/60 hover:border-emerald-500/60 text-white rounded-2xl overflow-hidden transition-all duration-300 shadow-xl hover:shadow-[0_0_30px_rgba(16,185,129,0.35)] hover:-translate-y-0.5">
                                ...
                                <div className="px-6 py-4 flex-1 flex items-center justify-between">
                                    <div className="text-left">
                                        <div className="font-bold text-sm md:text-base flex items-center gap-2 text-white group-hover:text-emerald-200 transition-colors">
                                            ดูหลักสูตรฝึกอบรม <span className="bg-emerald-500/90 text-white text-[10px] font-extrabold px-2 py-0.5 rounded-full leading-none uppercase shadow-sm shadow-emerald-500/50 animate-pulse">AVAILABLE</span>
                                        </div>
